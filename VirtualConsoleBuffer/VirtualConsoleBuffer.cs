namespace HACC.VirtualConsoleBuffer
{
    ...
    public class VirtualConsoleBuffer : IAnsiConsole
    {
        ...
        public ConsoleColor BackgroundColor
        {
            get
            {
                return TerminalSettings.TerminalBackground;
            }
            set
            {
                TerminalSettings.TerminalBackground = value;
            }
        }
        ...
        public int CursorLeft
        {
            get
            {
                return TerminalSettings.CursorPosition.X;
            }
            set
            {
        ...
        public int CursorSize
        {
            get
            {
                return TerminalSettings.CursorSize;
            }
            set
            {
        ...
        public int CursorTop
        {
            get
            {
                return TerminalSettings.CursorPosition.Y;
            }
            set
            {
                TerminalSettings.CursorPosition = new Point(
        ...
        public bool CursorVisible
        {
            get
            {
                return TerminalSettings.CursorVisible;
            }
            set
            {
        ...
        public ConsoleColor ForegroundColor
        {
            get
            {
                return TerminalSettings.TerminalForeground;
            }
            set
            {
